...
import org.ksh.mission1.api.ApiConfig;
import org.ksh.mission1.api.ApiService;
import org.ksh.mission1.dao.MysqlConnector;
import org.ksh.mission1.dao.WifiDAO;
...
public class LoadWifiServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ApiClient apiClient = new ApiClient(ApiConfig.URL, ApiConfig.API_KEY, ApiConfig.TYPE, ApiConfig.SERVICE);
        ...
        try {
            ...
            WifiResponse wifiResponse = new ApiService(apiClient).getWifiInfo(1, 1);
