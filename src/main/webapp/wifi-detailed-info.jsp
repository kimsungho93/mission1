<%@ page import="org.ksh.mission1.dto.WifiDTO" %>
...
<head>
    ...
    <script type="text/javascript" src="./js/boomark.js" charset="UTF-8"></script>
    <script>
...
<form id="insertBookmarkForm" action="InsertBookmarkServlet" method="GET">
    ...
    <input type="hidden" id="mgrNo" name="mgrNo" value="<%=wifiDTO != null ? wifiDTO.getX_SWIFI_MGR_NO() : "" %>">
    <div>
