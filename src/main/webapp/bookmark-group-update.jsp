<%@ page import="org.ksh.mission1.dao.BookmarkGroupDAO" %>
<%@ page import="org.ksh.mission1.dto.BookmarkGroupDTO" %>
...
<main>
    <form action="bookmark/UpdateBookmarkGroupServlet" method="GET">
        ...
        <table class="tables">
            ...
            <tr>
                <td colspan="2">
                    <a href="bookmark-group-view.jsp">돌아가기</a> | <button type="button" onclick="updateBookmarkGroup()">수정</button>
                </td>
            </tr>
        </table>
    </form>
